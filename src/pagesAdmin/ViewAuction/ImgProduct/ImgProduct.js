...
function ImgProduct({ data }) {
    ...
    useEffect(() => {
        ...
        btnDots = document.querySelectorAll('.thumbnail-1');
        ...
        <Row className={cx('row')}>
            <Col className={cx('col', 'l-2')}>
                <div class='wrapper-thumbnail'>
                    <img src={data.img} alt={data.name} class="thumbnail-1" />
                    <img src={data.thumbnail1} alt={data.name} class="thumbnail-1" />
                    <img src={data.thumbnail2} alt={data.name} class="thumbnail-1" />
                    <img src={data.thumbnail3} alt={data.name} class="thumbnail-1" />
                </div>
            </Col>
